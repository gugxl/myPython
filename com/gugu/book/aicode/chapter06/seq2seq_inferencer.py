...
decoder_outputs, state_h_dec, state_c_enc = decoder_lstm(decoder_inputs, initial_state=decoder_states_inputs)
decoder_states = [state_h_dec, state_c_enc]
...
def decode_sequence(input_seq, max_decoder_seq_length):
    # 首先用encoder模型对输入序列进行预测，获得其内部状态(既该模型输出)
